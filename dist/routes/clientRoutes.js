...
router.post("/signup", signupLimiter, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingUser = yield prisma.clientInfo.findUnique({
            where: { email },
        });
        if (existingUser) {
...
router.post("/verifyotp", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const client = yield prisma.clientInfo.create({
            data: {
        ...
        const token = jsonwebtoken_1.default.sign({ clientId: client.id, email: client.email, role: "client" }, process.env.JWT_SECRET, { expiresIn: "10m" });
...
router.post("/signin", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const client = yield prisma.clientInfo.findUnique({
            where: { email },
        });
        if (!client || !(yield bcrypt_1.default.compare(password, client.password))) {
            return res
                .status(401)
...
// Client OTP verify and password reset
router.post("/otpverify", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prisma.clientInfo.update({
            where: { email },
...
/* prettier-ignore */
router.get("/protected", authMiddleware_1.authenticateToken, authMiddleware_2.authorizeClient, (req, res) => {
    res.status(200).json({
        message: "This is a protected route for clients only",
    });
});
